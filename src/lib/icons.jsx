...
export function IconBall({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" />
      <path d="M4.93 4.93C6.58 7.58 7.5 9.67 7.5 12s-.92 4.42-2.57 7.07" />
      <path d="M19.07 4.93C17.42 7.58 16.5 9.67 16.5 12s.92 4.42 2.57 7.07" />
...
export function IconThree({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 5h7a5 5 0 0 1 0 10H5" />
      <path d="M5 19h7" />
      <path d="M12 12h.01" />
    </svg>
  )
...
export function IconPass({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 12H3" />
...
export function IconReb({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function IconTrophy({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M7 4H2v3a5 5 0 0 0 5 5" />
      <path d="M17 4h5v3a5 5 0 0 1-5 5" />
      <path d="M7 4a5 5 0 0 0 5 5 5 5 0 0 0 5-5V2H7v2z" />
    </svg>
  )
}
...
export function IconArrow({ size = 16, color = 'currentColor', dir = 'right' }) {
...
export function IconHoop({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round">
      <ellipse cx="12" cy="8" rx="8" ry="3" />
      <line x1="4" y1="8" x2="4" y2="20" />
      <line x1="20" y1="8" x2="20" y2="20" />
      <path d="M9 11v8a3 3 0 0 0 6 0v-8" />
    </svg>
  )
}
